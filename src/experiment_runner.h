...
public:
	...
	const std::vector<optAngle> optAngles{
		...
		optAngle(
				5,
				//CM
				{0.581084473971001, 2.97195826759163,
				3.00884790477691, 2.8418904311871, 0.725315440603853,
				-0.705145445383647, 0.282660066593032, -2.76262546890256,
				-1.46975964207813, -0.137384482741824},
				-0.145112333926423,
				-0.90137365376362,
				"CM: optimized by alpha, ROUNDOFF_LIMITED, num_iters: 2194",
				//QAOA
		...
		/*optAngle(
		                                ...
		                                -0.145112333926423,
		                                -0.90137365376362,
		                                "CM: optimized by diff, ROUNDOFF_LIMITED, num_iters: 2194",
		                                //QAOA
		                                {2.43879164627476, 2.04067081577967,
		                                2.19454742110229, 2.24894112948291, 0.746298445800395,
		                                -0.0816571540385876, -1.30216166822562, -2.79171092749313,
		                                0.143356324066653, -0.271861845887957},
		                                0.586604903400833,
		                                -0.91669749600054,
		                                "QAOA: optimized by diff, ROUNDOFF_LIMITED, num_iters: 2308"
		                ),*/
		optAngle(
				6,
				//CM
